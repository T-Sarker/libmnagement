            ...
            <?php
                  ...
                  ?>
                    ...
                    <?php
                        ...
                        ?>
          <!-- <tr>
                  <td data-label="Cover"><img src="../img/1cover.jpeg" alt=""></td>
                  <td data-label="Title">Importance of Education</td>
                  <td data-label="Author">Dominic</td>
                  <td data-label="Type">Hardcopy</td>
                  <td data-label="Issue Date">12-06-2021</td>
                  <td data-label="Due">240TK</td>
                  <td data-label="Status">
                    <button type="button" class="btn wishremove allitembtn">Date Expired</button>
                  </td>
                </tr>
                <tr>
                    <td data-label="Cover"><img src="../img/1cover.jpeg" alt=""></td>
                    ...
                    <td data-label="Type">Hardcopy</td>
                    <td data-label="Issue Date">12-06-2021</td>
                    <td data-label="Due">---</td>
                    <td data-label="Status">
                      <button type="button" class="btn allitembtn">Not Returned</button>
                    </td>
                  </tr>
                  <tr>
                    <td data-label="Cover"><img src="../img/1cover.jpeg" alt=""></td>
                    ...
                    <td data-label="Due">---</td>
                    <td data-label="Status">
                      <button type="button" class="btn allitembtn">Returned</button>
                    </td>
                  </tr>
                  <tr>
                    <td data-label="Cover"><img src="../img/1cover.jpeg" alt=""></td>
